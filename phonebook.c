...
{
	FILE *fptr, *fptr1;
	char name[100], address[100], gmail[100], gmail1[100], address1[100], name1[50], gender[8], name2[50];
	int res, f = 0;
	double phone, phone1;
	fptr = fopen("phoneBook.txt", "r");
	fptr1 = fopen("temp.txt", "a");
...
void start()
{
	char passwords[20] = {"phoneBookdon"};
	gotoxy(22, 2);
	int j;
	int z;
	char name[40] = "Welcome to Phone Book";
	z = strlen(name);
	for (j = 0; j <= 16; j++)
	{
		Sleep(50);
